...
using static KitchenMacAndCheese.Base_Ready_Mac;

namespace KitchenMacAndCheese
{
    public class Egged_Dogged_Ready_Mac : CustomItem
    {
        public override string UniqueNameID => "TestItem229111";
        public override GameObject Prefab => Main.bundle.LoadAsset<GameObject>("ready_egg_dogged_mac");
        ...
        public override Item SplitSubItem => GetCastedGDO<Item, Split_Egged_Dogged_Mac>();
        ...
        public override void OnRegister(GameDataObject gameDataObject)
        {
            ...
            MaterialUtils.ApplyMaterial(item.Prefab, "Egg", new Material[] {
                MaterialUtils.GetExistingMaterial("Egg - White"),
                MaterialUtils.GetExistingMaterial("Egg - Yolk")
            });
            MaterialUtils.ApplyMaterial(item.Prefab, "Egg.001", new Material[] {
                MaterialUtils.GetExistingMaterial("Egg - White"),
                MaterialUtils.GetExistingMaterial("Egg - Yolk")
            });
            ////portion 1 materials
